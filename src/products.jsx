      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 w-full flex-grow">
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            <Link to="/signup" className="text-2xl sm:text-3xl font-bold text-
gray-800 hover:text-purple-600 transition-colors">BizzySite</Link>
          </div>
          <h2 className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8">Welcome 
to your business dashboard</h2>
          <p className="text-gray-700 mb-6 sm:mb-8 text-sm sm:text-base">Set up 
your online store in minutes and start selling today</p>
        </div>

        <div className="relative">
          <div className="flex overflow-x-auto pb-2 mb-6 sm:mb-8 scrollbar-
hide">
            <div className="flex space-x-2 sm:space-x-6 px-2 py-2 bg-gray-50 
rounded-lg min-w-max">
              {[
                ...
                <Link
                  to={tab.path}
                  key={tab.name}
                  className={`flex items-center gap-2 px-3 sm:px-4 py-2 font-
medium rounded-md focus:outline-none text-sm sm:text-base ${
                    activeTab === tab.name
...
center mb-4 sm:mb-6 gap-3">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Product
 Catalog</h1>
            <p className="text-gray-600 text-sm sm:text-base">Manage your 
products and inventory</p>
          </div>
          <button
            onClick={handleAddProductClick}
            className="px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-600 text-white 
rounded-md hover:bg-indigo-700 flex items-center text-sm sm:text-base w-fit"
          >
...
hover:bg-indigo-700 text-sm sm:text-base"
              >
...
lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
...
gray-800 line-clamp-1">{product.name}</h3>
...
rounded text-xs font-medium ${
                      product.inStock ? 'bg-green-100 text-green-800' : 'bg-
...
mb-3 sm:mb-4">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-4 sm:mb-6">
                      <label htmlFor="product-name" className="block text-sm 
...
sm:text-base"
                    ...
                    <div className="mb-4 sm:mb-6">
                      <label htmlFor="product-price" className="block text-sm 
font-medium text-gray-700 mb-1">
...
md bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm 
sm:text-base"
                        >
...
/^[0-9]*\.?[0-9]*$/.test(e.target.value)) {
                          ...
                          placeholder="0"
                          className="flex-1 px-3 py-2 border-t border-b border-r
 border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-
...
01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 
28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02"
                          ...
                          <div className="flex text-sm text-gray-600 flex-wrap 
justify-center">
                            <label
                              htmlFor="file-upload"
                              className="relative cursor-pointer bg-white 
rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-
within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-
within:ring-indigo-500"
                            >
...
border-gray-300 rounded"
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="mr-3 px-3 py-1.5 sm:px-4 sm:py-2 border 
border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 focus:outline-none 
focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-sm sm:text-base"
                      >
                        Cancel
                      </button>
                      <button
                        type="submit"
                        className="px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-600 
text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 
focus:ring-offset-2 focus:ring-indigo-500 text-sm sm:text-base"
                      >
...
text-center text-gray-400 text-sm sm:text-base">
