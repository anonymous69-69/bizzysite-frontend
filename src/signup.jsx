...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://www.bizzysite.shop/api/${isLogin ? 'login' : 'signup'}`, {
        method: 'POST',
      ...
      if (!isLogin) {
        try {
          const businessRes = await fetch('https://www.bizzysite.shop/api/business', {
            method: 'POST',
            headers: {
          ...
          await fetch('https://www.bizzysite.shop/api/send-welcome-email', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
                  ...
                  <div className="text-right">
                    <button
                      ...
                      onClick={async () => {
                        ...
                        if (emailPrompt) {
                          try {
                            const res = await fetch("https://www.bizzysite.shop/api/request-password-reset", {
                              method: "POST",
                              headers: { "Content-Type": "application/json" },
                    ...
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          const res = await fetch('https://www.bizzysite.shop/api/google-login', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                              uid: user.uid,
